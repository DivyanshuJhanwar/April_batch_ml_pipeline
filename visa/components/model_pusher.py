...
from visa.entity.artifact_entity import ModelPusherArtifiact, ModelEvaluationArtifact
import os, sys
import shutil
...
class ModelPusher:
    ...
    def export_model(self)-> ModelPusherConfig:
        try:
            ...
            model_pusher_artifact = ModelPusherArtifiact(is_model_pusher=True,
    ...
    def initiate_model_pusher(self)-> ModelPusherArtifiact:
        try:
